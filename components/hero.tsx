      ...
      <div className="relative z-10 container flex min-h-[100svh] flex-col justify-end pb-14 pt-28">
        <div className="flex-1 flex flex-col justify-center">
          ...
          <motion.h1
            ...
            className="max-w-4xl text-[clamp(2.75rem,8vw,6.5rem)] font-semibold tracking-[-0.03em] leading-[0.95] text-white"
          >
            Built on the floor.
            <br />
            Shipping{" "}
        ...
        {/* Bottom one-liner — matches Hydraoo footer text */}
        <motion.p
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7, delay: 0.24, ease }}
          className="mt-16 max-w-sm text-sm leading-relaxed text-white/50"
        >
